...
class TableRowAdapterDslop(private var userArrayListSV: ArrayList<User>) : RecyclerView.Adapter<TableRowAdapterDslop.ViewHolder>() {
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val itemView = LayoutInflater.from(viewGroup.context).inflate(R.layout.tablerowgvdslop, viewGroup, false)
