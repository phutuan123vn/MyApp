...
class thu2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_thu2, container, false)
        val data=activity.createContext(this)
        dataInitlize(data)
        val layoutManager = LinearLayoutManager(context)
        tableRecyclerView = v.findViewById(R.id.table_recycler_view_thu2)
...
private fun FragmentActivity?.createContext(tHu2: thu2): ArrayList<User> {
