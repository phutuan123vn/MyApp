...
class thu4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_thu4, container, false)
        val data=activity.createContext(this)
        dataInitlize(data)
        val layoutManager = LinearLayoutManager(context)
        tableRecyclerView = v.findViewById(R.id.table_recycler_view_thu4)
...
private fun FragmentActivity?.createContext(tHu4: thu4): ArrayList<User> {
