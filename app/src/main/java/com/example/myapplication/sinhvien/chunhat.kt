...
class chunhat : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_chunhat, container, false)
        val data=activity.createContext(this)
        dataInitlize(data)
        val layoutManager = LinearLayoutManager(context)
        tableRecyclerView = v.findViewById(R.id.table_recycler_view_chunhat)
...
private fun FragmentActivity?.createContext(cHunhat: chunhat): ArrayList<User> {
